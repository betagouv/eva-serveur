...
RSpec.describe "Invitation invalide ou déjà utilisée", type: :request do
  it "redirige vers la home avec un message d'erreur" do
  ...
  it "redirige vers la home si l'invitation est annulée" do
  ...
  it "redirige vers la home si l'invitation a déjà été acceptée" do
