...
describe Restitution::Inventaire::OrganisationMethode do
  ...
  def expect_niveau(nombre_ouvertures, niveau_attendu)
  ...
  context 'en cas de réussite' do
    ...
    describe "pour la version originale de l'inventaire" do
      ...
      it { expect_niveau(70, Competence::NIVEAU_4) }
      it { expect_niveau(71, Competence::NIVEAU_3) }
      it { expect_niveau(120, Competence::NIVEAU_3) }
      it { expect_niveau(121, Competence::NIVEAU_2) }
      it { expect_niveau(250, Competence::NIVEAU_2) }
      it { expect_niveau(251, Competence::NIVEAU_1) }
    end

    describe "pour la version 2 de l'inventaire" do
      before { allow(restitution).to receive(:version?).with('2').and_return(true) }

      it { expect_niveau(42, Competence::NIVEAU_4) }
      it { expect_niveau(43, Competence::NIVEAU_3) }
      it { expect_niveau(71, Competence::NIVEAU_3) }
      it { expect_niveau(72, Competence::NIVEAU_2) }
      it { expect_niveau(148, Competence::NIVEAU_2) }
      it { expect_niveau(149, Competence::NIVEAU_1) }
    end
  end
