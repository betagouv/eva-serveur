...
ActiveRecord::Schema.define(version: 2021_07_23_083454) do
  ...
  create_table "actualites", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "titre"
    t.text "contenu"
    t.integer "categorie"
  ...
  create_table "annonce_generales", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "texte"
    t.boolean "afficher"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "campagnes", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "libelle"
    t.string "code"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "choix", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "intitule"
  ...
  create_table "comptes", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
  ...
  create_table "demandes_accompagnement", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["compte_id"], name: "index_demandes_accompagnement_on_compte_id"
    t.index ["evaluation_id"], name: "index_demandes_accompagnement_on_evaluation_id"
  end

  create_table "evaluations", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "nom"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.uuid "campagne_id"
  ...
  create_table "evenements", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "nom"
  ...
  create_table "questionnaires_questions", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.integer "position"
  ...
  create_table "questions", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "intitule"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "type"
  ...
  create_table "questions_frequentes", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "question"
    t.text "reponse"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "situations", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "libelle"
    t.string "nom_technique"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "situations_configurations", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.uuid "campagne_id"
  ...
  create_table "source_aides", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "titre"
    t.text "description"
    t.string "url"
    t.integer "categorie"
  ...
  create_table "structures", id: :uuid, default: -> { "public.gen_random_uuid()" }, force: :cascade do |t|
    t.string "nom"
  ...
  add_foreign_key "demandes_accompagnement", "comptes"
  add_foreign_key "demandes_accompagnement", "evaluations"
