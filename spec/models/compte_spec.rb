...
describe Compte do
  ...
  describe "validation de la fonction pour les comptes Pro Connect" do
    context "quand id_pro_connect est rempli" do
      let(:compte) do
        build :compte,
              id_pro_connect: "12345",
              nom: "Dupont",
              prenom: "Jean",
      ...
      context "quand la fonction est vide" do
        ...
        it "signale une erreur sur le champ fonction" do
          expect(compte.errors[:fonction]).not_to be_blank
        end
      end

      context "quand la fonction est remplie" do
        before do
          compte.fonction = "conseillere_ou_conseiller_emploi_formation_insertion"
          compte.valid?
        end
    ...
    context "quand id_pro_connect est vide" do
      let(:compte) do
        build :compte,
              id_pro_connect: nil,
              nom: "Dupont",
