class CreationQuestionsNumeratieNiveau2 < ActiveRecord::Migration[7.0]
  ...
  def change
    numeratie = Questionnaire.find_or_create_by(nom_technique: 'numeratie_2024')
    {
      ...
      'QuestionQcm' => ['N2Plp2', 'N2Rlp1', 'N2Rlp2', 'N2Put1', 'N2Put2', 'N2Rut1', 'N2Rut2', 'N2Ptg2', 'N2Rtg1', 'N2Rtg2', 'N2Ppl1', 'N2Rpl1', 'N2Rpl2', 'N2Rrh2'],
      ...
      'QuestionGlisserDeposer' => ['N2Pon1', 'N2Pon2', 'N2Ron1', 'N2Ron2', 'N2Prh1', 'N2Prh2', 'N2Rrh1']
